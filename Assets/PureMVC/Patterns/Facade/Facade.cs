...
namespace PureMVC.Patterns
{
    ...
    public class Facade : Notifier, IFacade
    {
        ...
        /// </summary>
        /// <param name="notificationName">The name of the <c>INotification</c> to associate the <c>ICommand</c> with.</param>
        /// <param name="command">A reference to the <c>ICommand</c></param>
        ...
        /// <summary>
        /// Checking if facade name existed
        /// </summary>
        /// <param name="key">The key of facade</param>
        /// <returns>True if facade exists</returns>
        ...
        /// </summary>
        /// <returns>The list name of core</returns>
        ...
        /// <summary>
        /// Remove core out of container
        /// </summary>
        /// <param name="key">The key of facade to remove</param>
        ...
        ///     <para>This method is <i>rarely</i> overridden; in practice you are more likely to use a <c>Command</c> to create and register <c>Proxy</c>s with the <c>Model</c>, since <c>Proxy</c>s with mutable data will likely need to send <c>INotification</c>s and thus will likely want to fetch a reference to the <c>Facade</c> during their construction</para>
        /// </remarks>
        ...
        ///     <para>This method is <i>rarely</i> overridden; in practice you are more likely to use a <c>Command</c> to create and register <c>Mediator</c>s with the <c>View</c>, since <c>IMediator</c> instances will need to send <c>INotification</c>s and thus will likely want to fetch a reference to the <c>Facade</c> during their construction</para>
        /// </remarks>
